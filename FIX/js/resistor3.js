function calculateResistance() {
    ...
    resistance += " ± " + colors[color5] + "%" + " ; " + colors[color6] + " ppm/°C";
...
function changeColor() {
    ...
    var colors = {
        ...
        "s-hitam": "linear-gradient(to top, #000, #909090)",
        "s-coklat": "linear-gradient(to top, #741e1e, #d03737)",
        "s-merah": "linear-gradient(to top, #dd0000, #ff8888)",
        "s-jingga": "linear-gradient(to top, #ff5400, #ffda00)",
        "s-kuning": "linear-gradient(to top, #ffee05, #ffffbb)",
        "s-hijau": "linear-gradient(to top, #048042, #00ff7f 80%)",
        "s-biru": "linear-gradient(to top, #006666, #00ffff 80%)",
        "s-ungu": "linear-gradient(to top, #a202a2, #ff00ff 80%)",
        "s-kelabu": "linear-gradient(to top, #808080 60%, #dadada)",
    };
    ...
    box6.style.backgroundImage = colors[color6];
}
...
function resetInput() {
    ...
    document.getElementById("box6").style.backgroundImage = "linear-gradient(to top, #fffae8, #fffae8)";
